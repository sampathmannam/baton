...
interface PersonRepository {
     ...
     * M2-T7 Realtime subscription calls [com.kaavalan.note.data.local.RoomPersonRepository.refreshFromNetwork]
     ...
     * picks the mode from [com.kaavalan.note.data.vault.VaultModeHolder]
