 ...
 * that the [com.kaavalan.note.data.undo.UndoController] pushes
...
sealed interface UndoableAction {
    ...
    data class DeletePerson(
        ...
        val name: String,
        val row: com.kaavalan.note.data.local.entities.PersonEntity,
    ) : UndoableAction {
    ...
    data class DeleteInstruction(
        override val id: String,
        val title: String,
        val row: com.kaavalan.note.data.local.entities.InstructionEntity,
    ) : UndoableAction {
    ...
    data class DeleteCapture(
        override val id: String,
        val preview: String,
        val row: com.kaavalan.note.data.local.entities.CaptureEntity,
    ) : UndoableAction {
     ...
     * and `updatedAt` (ISO string) so [com.kaavalan.note.data.undo.UndoController.undoLast]
