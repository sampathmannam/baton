 ...
 * row. Every state change that the [com.kaavalan.note.data.local.SyncEngine]
 ...
 * [com.kaavalan.note.data.audit.AuditChainVerifier] walks the
 ...
 * [com.kaavalan.note.data.retention.RetentionWorker].
 *
...
data class AuditChainEventEntity(
     ...
     * [com.kaavalan.note.data.audit.AuditChainWriter] from
