...
object WorkManagerInitializer {
     ...
     * [com.kaavalan.note.data.captures.RoomCaptureRepository] wrote
     * every capture to Room with `syncStatus = PENDING_INSERT` and
     * a separate worker pushed the row to Supabase.
     *
     * **v2.0.0 (drop Supabase):** [com.kaavalan.note.data.sync.CaptureSyncWorker]
     ...
     * [com.kaavalan.note.data.auth.SecurePreferences]).
     */
