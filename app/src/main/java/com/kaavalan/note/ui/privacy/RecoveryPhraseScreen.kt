...
private fun DisplayStep(
    ...
    // ("Kaavalan recovery phrase") and the same package
    ...
    DisposableEffect(Unit) {
        onDispose {
            ...
            if (current != null &&
                current.description?.label == "Kaavalan recovery phrase"
            ) {
            ...
            Column(
                ...
                Button(
                    onClick = {
                        ...
                        val clip = ClipData.newPlainText("Kaavalan recovery phrase", phrase)
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
