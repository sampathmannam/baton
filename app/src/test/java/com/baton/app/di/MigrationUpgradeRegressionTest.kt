 ...
 * generates from the
 * [com.baton.app.data.local.entities.InstructionFtsEntity],
 ...
 * [com.baton.app.di.DatabaseModule] wires the
 * [com.baton.app.data.local.AppDatabase] through SQLCipher
...
class MigrationUpgradeRegressionTest {
     ...
     * via [com.baton.app.data.auth.SecurePreferences]). The
