...
Usage (from the repo root):
    python app/src/test/java/com/baton/app/tools/GeneratePlayStoreScreenshots.py
...
# Baton brand palette — kept in sync with `ui/theme/Color.kt`.
...
SCREENS = [
    ...
    ("03-capture", "Capture", "Type, dictate, or shoot a photo. Baton ties every note to a person, not a folder."),
    ...
    ("07-threat-model", "Threat model", "What Baton protects against, what it does not, and what you are responsible for."),
...
def draw_screen(out: Path, name: str, title: str, caption: str) -> None:
    ...
    draw.text((70, 155), "Baton  |  v1.9.1  |  vault mode", font=font(28), fill=CHARCOAL)
    # TopAppBar
